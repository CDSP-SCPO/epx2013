...
class ActsInformationModel(models.Model):
	...
	#oeil
	commissionPE=models.CharField(max_length=10, blank=True, null=True, default=None)
	epComAndtTabled=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epComAndtAdopt=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesFor1=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesAgst1=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesAbs1=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesFor2=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesAgst2=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	epVotesAbs2=models.IntegerField(max_length=3, blank=True, null=True, default=None)
	groupePolitiqueRapporteur1=models.CharField(max_length=10, blank=True, null=True, default=None)
	rapporteurPE1=models.CharField(max_length=50, blank=True, null=True, default=None)
	etatMbRapport1=models.CharField(max_length=5, blank=True, null=True, default=None)
	groupePolitiqueRapporteur2=models.CharField(max_length=10, blank=True, null=True, default=None)
	rapporteurPE2=models.CharField(max_length=50, blank=True, null=True, default=None)
	modifPropos=models.BooleanField(default=False)
	nombreLectures=models.IntegerField(max_length=1, blank=True, null=True, default=None)
