...
class ActsInformationModel(models.Model):
	...
	prelexAdoptCSContre=models.CharField(max_length=30, blank=True, null=True, default=None)
	prelexAdoptCSAbs=models.CharField(max_length=30, blank=True, null=True, default=None)
	prelexAdoptPCContre=models.CharField(max_length=30, blank=True, null=True, default=None)
	prelexAdoptPCAbs=models.CharField(max_length=30, blank=True, null=True, default=None)
