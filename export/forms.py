...
class Export(forms.Form):
    ...
    def sort_fields_qs():
        ...
        """
        qs=[]
        excluded_list=['id', 'actids', 'releve_annee', 'releve_mois', 'releve_mois_init', 'no_ordre', 'titre_rmc', 'council_path', 'date_doc', 'url_prelex', 'notes', 'validated', 'np', 'gvt_compo', 'minattend']
