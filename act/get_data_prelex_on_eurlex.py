...
#HIS
#http://new.eur-lex.europa.eu/legal-content/EN/HIS/?uri=CELEX:32006R0816
#in front of the second Joint leading service: (old: "Jointly responsible")
#can be Null
...
#HIS
#in front of Leading service (old in front of "Primarily responsible")
#can be Null
...
#~ in front of Leading person (old: "Responsible")
#can be Null
...
#~ date in front of "Formal adoption by Council" or "Adoption common position" or "Council approval on 1st reading" (old: "Council approval 1st rdg")
#not Null
#~ AAAA-MM-JJ format
