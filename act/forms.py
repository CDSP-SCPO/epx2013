...
class Add(forms.Form):
	...
	"""
	act_to_validate=forms.ModelChoiceField(queryset=Act.objects.only("releve_annee", 'releve_mois', 'no_ordre').filter(validated=1), empty_label="Select an act to validate")
