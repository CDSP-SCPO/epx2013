...
var DateTimeShortcuts={
    ...
    calendarInputs: [],
    clockInputs: [],
    calendarDivName1: 'calendarbox', // name of calendar <div> that get toggled
    calendarDivName2: 'calendarin',  // name of <div> that contains calendar
    calendarLinkName: 'calendarlink',// name of the link that is used to toggle
    clockDivName: 'clockbox',        // name of clock <div> that get toggled
    ...
    openClock: function(num) {
        ...
        if (getStyle(document.body,'direction')!='rtl') {
            ...
            // TODO: IE return wrong value for findPosX when in rtl mode
            //       (it return as it was left aligned), needs to be fixed.
