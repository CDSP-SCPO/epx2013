...
def getAdoptionProposOrigineFromPrelex(soup, proposOrigine):
	...
	if proposOrigine=="CONS":
		print "TODO: extraction pdf almost done (see tests sub directory)"
		return "00-00-0000"
...
def specialDgSearch(dg):
	...
	if dg=="DG Enlargement":
		return "ELARG"
	if dg==u"DG Development and Cooperation — EuropeAid" or dg=="EuropeAid Development and Cooperation DG" or dg=="EuropeAid Development and Cooperation Directorate-General" or dg==u"Directorate-General for Development and Cooperation — EuropeAid" or dg==u"Development and Cooperation DG — EuropeAid":
		return "DEVCO"
