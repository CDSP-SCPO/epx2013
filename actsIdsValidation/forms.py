...
class ActsIdsForm(forms.ModelForm):
	...
	#EURLEX
	fileNoCelex=forms.RegexField(regex=r'^[0-9](195[789]|19[6-9][0-9]|20[0-1][0-9])[dflrDFLR][0-9]{4}(\(01\)|R\(01\))?$')
	#~ noCelex
	...
	#normal case
	fileProposOrigine = forms.RegexField(regex=r'^COM|JAI|BCE|EM|CONS$', required=False)
	...
	fileProposChrono = forms.RegexField(regex=r'^([1-9]([0-9]?){4})(-[1-9])?$', required=False)
