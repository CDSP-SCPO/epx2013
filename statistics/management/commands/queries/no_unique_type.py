...
def q98()
    ...
    for key, value in variables.iteritems():
        ...
        print question
        res=init_cs()
        res=get_by_cs(res, Model=ActIds, filter_vars={"act__validated": 2, "src": "index", "act__nb_lectures_isnull": False}, check_vars_act={"nb_lectures": key}, check_vars_act_ids={"no_unique_type": "COD"})
